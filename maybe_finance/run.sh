...
PLAID_CLIENT_ID=$(jq --raw-output '.plaid_client_id' "$CONFIG_PATH")
PLAID_SECRET=$(jq --raw-output '.plaid_secret' "$CONFIG_PATH")
PLAID_ENV=$(jq --raw-output '.plaid_env' "$CONFIG_PATH")
